...
class CreateAttendanceTemporariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('attendance_temporaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('attendance_temporaries');
    }
}
