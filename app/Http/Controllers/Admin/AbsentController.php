...
class AbsentController extends Controller
{
    ...
    public function validation(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('absents')->with('success', 'Absent validation successfully');
        } catch (\Throwable $th) {
            //throw $th;
    ...
    public function rejection(Request $request, $id)
    {
        ...
        try {
            ...
            // dd($absent);
            return redirect()->route('absents')->with('success', 'Absent rejection successfully');
        } catch (\Throwable $th) {
            //throw $th;
    ...
    public function destroy($id)
    {
        ...
        try {
            $absent->delete();
            return redirect()->route('absents')->with('success', 'Absent deleted successfully');
        } catch (\Throwable $th) {
            //throw $th;
