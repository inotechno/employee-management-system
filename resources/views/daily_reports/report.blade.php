    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Daily Report Employee</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Report</a></li>
                        <li class="breadcrumb-item active">Daily Report Employee</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('report.daily_report.download') }}" method="POST" autocomplete="off">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#preview').on('click', function() {
                ...
                var url = "{{ url('report/daily_report/preview') }}";
