...
@section('plugin')
    ...
    <script>
        $(function() {
            ...
            var table = $("#daily_reports-table").DataTable({
                lengthChange: !1,
                processing: true,
                serverSide: true,
                order: [
                ...
                ajax: {
                    url: '{{ route('daily_reports.datatable') }}',
                    type: "POST",
                    data: function(d) {
                        d._token = CSRF_TOKEN;
            ...
            $('#daily_reports-table').on('click', '.btn-delete', function() {
                var id = $(this).data('id');
                $('#form-delete').attr('action', "{{ url('admin/daily-report/delete') }}/" + id);
