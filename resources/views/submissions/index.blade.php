    ...
    <script>
        $(function() {
            ...
            var table = $("#submission-table").DataTable({
                ...
                ajax: {
                    url: '{{ route('submission.datatable') }}',
                    type: "POST",
                    data: function(d) {
                        d._token = CSRF_TOKEN;
                    }
            ...
            $('#submission-table').on('click', '.btn-validation', function() {
                var id = $(this).data('id');
                $('#form-validation').attr('action', "{{ url('admin/submission/validation') }}/" +
                    id);
            ...
            $('#submission-table').on('click', '.btn-rejection', function() {
                var id = $(this).data('id');
                $('#form-rejection').attr('action', "{{ url('admin/submission/rejection') }}/" + id);
            ...
            $('#submission-table').on('click', '.btn-delete', function() {
                var id = $(this).data('id');
                $('#form-delete').attr('action', "{{ url('admin/submission/delete') }}/" + id);
