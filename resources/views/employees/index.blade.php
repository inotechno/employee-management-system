                        ...
                        <div class="float-end">
                            <div class="input-group input-group-sm">
                                <a href="{{ route('import_data.template') }}" class="btn btn-warning"
                                    ...
                                    Template Update</a>
                                {{-- <a href="{{ route('import_data.template.insert') }}" class="btn btn-warning"
                                    style="margin-right: 8px;">Download
                                    Template Insert</a> --}}
                                <a href="{{ route('import_data.employee') }}" class="btn btn-info"
                                    style="margin-right: 8px;">Insert/Update Massal</a>
    ...
    <script>
        $(function() {
            ...
            $('#employees-table').on('click', '.btn-delete', function() {
                var id = $(this).data('id');
                $('#form-delete').attr('action', "{{ url('admin/employees/delete') }}/" + id);
