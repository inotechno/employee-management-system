        ...
        <div class="card">
            ...
            <div>
                         ...
                         <li>
                             <div class="conversation-list">
                                 <div class="ctext-wrap">
                                     <div class="conversation-name">@if($item->user) {{ $item->user->name }}@endif</div>
                                     <p>
                                         {{ $item->comment  }}
                                     </p>
                                     <p class="chat-time mb-0"><i class="bx bx-time-five align-middle me-1"></i>{{ $item->created_at->format('h:i') }} </p>
                                 </div>
                             </div>
                         </li>
                         @else
                ...
                <div class="p-3 chat-input-section">
                    <div class="row">
                        <form action="{{ route('daily_report_comment.finance',$daily_report) }}" method="post">
                            @csrf
                            <div class="col">
