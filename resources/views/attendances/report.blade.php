    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Report Attendance</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('report.attendance.download') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-daterange input-group" data-date-format="yyyy-mm-dd"
                                        ...
                                        <input type="text" name="periode_end"
                                            ...
                                            placeholder="Periode End" value="{{ old('periode_end') }}" />
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#preview').on('click', function() {
                ...
                var url = "{{ url('report/attendance/preview') }}";
