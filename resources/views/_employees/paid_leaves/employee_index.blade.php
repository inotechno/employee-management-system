    ...
    <script>
        $(function() {
            var table = $("#paid_leave-table").DataTable({
                ...
                ajax: {
                    url: "{{ route('paid_leaves.datatable.all') }}",
                },
                columnDefs: [{
                ...
                columns: [{
                    ...
                    {
                        data: 'employee.jumlah_cuti',
                        name: 'employee.jumlah_cuti',
                        width: '2%'
                    },
                    {
                        data: 'created_at',
            ...
            $('#paid_leave-table').on('click', '.btn-validation', function() {
                var id = $(this).data('id');
                $('#form-validation').attr('action', "{{ url('paid-leaves/validation') }}/" + id);
            ...
            $('#paid_leave-table').on('click', '.btn-rejection', function() {
                var id = $(this).data('id');
                $('#form-rejection').attr('action', "{{ url('paid-leaves/rejection') }}/" + id);
