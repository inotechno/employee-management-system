                    ...
                    <div class="row">
                        <div class="d-flex flex-wrap gap-4 mt-5">
                            @foreach ($daily_report->getMedia('media') as $image)
                                <span>
                                    <h5 class="font-size-14 mb-1"><a target="_blank"  href="{{ $image->getUrl() }}"
                                            title="{{ $image->getUrl() }}" class="text-dark">{{ $image->file_name }}</a>
                                    </h5>
            ...
            <div class="card">
                ...
                <div>
                    ...
                    <div class="p-3 chat-input-section">
                        <div class="row">
                            <form action="{{ route('daily_report_comment.employee', $daily_report) }}" method="post">
                                @csrf
                                <div class="col">
