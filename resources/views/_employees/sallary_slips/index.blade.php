            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="clearfix row">
                        <div class="col-md">
                            <h4 class="card-title">Daftar Slip Gaji</h4>
                            <p class="card-title-desc">Dibawah ini merupakan data slip gaji yang anda terima.
                            </p>
                        </div>
                    </div>
    ...
    <script>
        $(function() {
            ...
            var table = $("#history-table").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('sallary_slip.datatable.employee') }}',
                    type: 'POST',
                    data: function(d) {
                        d._token = CSRF_TOKEN;
