        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="clearfix">
                        <div class="float-end">
                            <div class="input-group input-group-sm">
                                <a href="{{ route('positions.create.hrd') }}" class="btn btn-info">
                    ...
                    <table id="positions-table" class="table table-bordered w-100">
                        <thead>
                            <tr>
    ...
    <script>
        $(function() {
            ...
            $("#positions-table").DataTable({
                ...
                ajax: {
                    url: "{{ route('positions.datatable.hrd') }}",
                    type: "POST",
                    data: {
                        "_token": CSRF_TOKEN,
                    }
            ...
            $('#positions-table').on('click', '.btn-delete', function() {
                var id = $(this).data('id');
                $('#form-delete').attr('action', "{{ url('hrd/positions/delete') }}/" + id);
