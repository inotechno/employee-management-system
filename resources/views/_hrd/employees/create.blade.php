        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Form ini digunakan untuk menambahkan data karyawan, isi sesuai dengan
                        title input.
                    </p>

                    <form action="{{ route('employees.store.hrd') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
