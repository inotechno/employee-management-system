        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Form ini digunakan untuk merubah Announcement, isi sesuai
                        dengan title input.
                    </p>

                    <form action="{{ route('announcements.update.hrd',$announcement->id) }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        @method('PUT')
